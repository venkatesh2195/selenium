...
public class Checking_Checkbox {
public static void main(String[] args) throws Throwable {
		WebDriver driver=new ChromeDriver();
		driver.navigate().to("file:///C:/Users/venkatesh/Downloads/checkbox_1.html");
		...
		{
			//get each checkboxes name which is stored into value property
